...
//! # Status
//!
//! Tests run by default (red/green TDD — failures are work items).
//! Tests that fail at parse time skip gracefully via `require_samples!()`.
//! Failing tests indicate deserializer/content-model mismatches to fix.
//!
//! # Workflow
//!
...
fn sample_encodings_music_dir() -> PathBuf {
    Path::new(env!("CARGO_MANIFEST_DIR"))
        .join("../fixtures/mei/sample-encodings/MEI_5.1/Music")
}
