...
impl MeiSerialize for BeamChild {
    fn element_name(&self) -> &'static str {
        match self {
            ...
            BeamChild::ClefGrp(_) => "clefGrp",
            BeamChild::BTrem(_) => "bTrem",
            BeamChild::FTrem(_) => "fTrem",
            BeamChild::BarLine(_) => "barLine",
            BeamChild::KeySig(_) => "keySig",
            BeamChild::MeterSig(_) => "meterSig",
            BeamChild::MeterSigGrp(_) => "meterSigGrp",
            BeamChild::Custos(_) => "custos",
            BeamChild::TabDurSym(_) => "tabDurSym",
            BeamChild::TabGrp(_) => "tabGrp",
            BeamChild::Pad(_) => "pad",
            BeamChild::HandShift(_) => "handShift",
            BeamChild::HalfmRpt(_) => "halfmRpt",
            BeamChild::BeatRpt(_) => "beatRpt",
            BeamChild::Supplied(_) => "supplied",
            BeamChild::Subst(_) => "subst",
            BeamChild::App(_) => "app",
            BeamChild::Reg(_) => "reg",
            BeamChild::Del(_) => "del",
            BeamChild::Corr(_) => "corr",
            BeamChild::Add(_) => "add",
            BeamChild::Restore(_) => "restore",
            BeamChild::Choice(_) => "choice",
            BeamChild::Unclear(_) => "unclear",
            BeamChild::Orig(_) => "orig",
            BeamChild::Gap(_) => "gap",
            BeamChild::Damage(_) => "damage",
            BeamChild::Sic(_) => "sic",
        }
    }
    ...
    fn serialize_mei<W: Write>(&self, writer: &mut MeiWriter<W>) -> SerializeResult<()> {
        match self {
            ...
            BeamChild::ClefGrp(clef_grp) => clef_grp.serialize_mei(writer),
            BeamChild::BTrem(btrem) => btrem.serialize_mei(writer),
            BeamChild::FTrem(ftrem) => ftrem.serialize_mei(writer),
            BeamChild::BarLine(bar_line) => bar_line.serialize_mei(writer),
            BeamChild::KeySig(key_sig) => key_sig.serialize_mei(writer),
            BeamChild::MeterSig(meter_sig) => meter_sig.serialize_mei(writer),
            BeamChild::MeterSigGrp(meter_sig_grp) => meter_sig_grp.serialize_mei(writer),
            BeamChild::Custos(custos) => custos.serialize_mei(writer),
            BeamChild::TabDurSym(tab_dur_sym) => tab_dur_sym.serialize_mei(writer),
            BeamChild::TabGrp(tab_grp) => tab_grp.serialize_mei(writer),
            BeamChild::Pad(pad) => pad.serialize_mei(writer),
            BeamChild::HandShift(hand_shift) => hand_shift.serialize_mei(writer),
            BeamChild::HalfmRpt(halfm_rpt) => halfm_rpt.serialize_mei(writer),
            BeamChild::BeatRpt(beat_rpt) => beat_rpt.serialize_mei(writer),
            BeamChild::Supplied(supplied) => supplied.serialize_mei(writer),
            BeamChild::Subst(subst) => subst.serialize_mei(writer),
            BeamChild::App(app) => app.serialize_mei(writer),
            BeamChild::Reg(reg) => reg.serialize_mei(writer),
            BeamChild::Del(del) => del.serialize_mei(writer),
            BeamChild::Corr(corr) => corr.serialize_mei(writer),
            BeamChild::Add(add) => add.serialize_mei(writer),
            BeamChild::Restore(restore) => restore.serialize_mei(writer),
            BeamChild::Choice(choice) => choice.serialize_mei(writer),
            BeamChild::Unclear(unclear) => unclear.serialize_mei(writer),
            BeamChild::Orig(orig) => orig.serialize_mei(writer),
            BeamChild::Gap(gap) => gap.serialize_mei(writer),
            BeamChild::Damage(damage) => damage.serialize_mei(writer),
            BeamChild::Sic(sic) => sic.serialize_mei(writer),
        }
    }
}
