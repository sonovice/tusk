...
use tusk_model::att::{
    ...
    AttNNumberLike, AttPointing, AttResponsibility, AttSlurAnl, AttSlurGes, AttSlurLog, AttSlurVis,
...
use tusk_model::elements::{
    ...
    PubStmtChild, RevisionDesc, RevisionDescChild, Slur, SlurChild, SourceDesc, SourceDescChild,
    Tempo, TempoChild, Tie, TieChild, Title, TitleChild, TitleStmt, TitleStmtChild, Tuplet,
    TupletChild,
};
