...
impl MeiSerialize for AnnotChild {
    fn element_name(&self) -> &'static str {
        match self {
            ...
            AnnotChild::District(_) => "district",
            AnnotChild::Depth(_) => "depth",
            AnnotChild::CastList(_) => "castList",
            AnnotChild::Rend(_) => "rend",
            AnnotChild::Repository(_) => "repository",
            AnnotChild::Lb(_) => "lb",
            AnnotChild::Abbr(_) => "abbr",
            AnnotChild::Restore(_) => "restore",
            AnnotChild::Catchwords(_) => "catchwords",
            AnnotChild::Heraldry(_) => "heraldry",
            AnnotChild::Add(_) => "add",
            AnnotChild::PostCode(_) => "postCode",
            AnnotChild::Unclear(_) => "unclear",
            AnnotChild::Subst(_) => "subst",
            AnnotChild::Region(_) => "region",
            AnnotChild::Ref(_) => "ref",
            AnnotChild::BiblList(_) => "biblList",
            AnnotChild::RelationList(_) => "relationList",
            AnnotChild::Quote(_) => "quote",
            AnnotChild::CorpName(_) => "corpName",
            AnnotChild::Signatures(_) => "signatures",
            AnnotChild::Num(_) => "num",
            AnnotChild::EventList(_) => "eventList",
            AnnotChild::Bibl(_) => "bibl",
            AnnotChild::Extent(_) => "extent",
            AnnotChild::Locus(_) => "locus",
            AnnotChild::Settlement(_) => "settlement",
            AnnotChild::Height(_) => "height",
            AnnotChild::Name(_) => "name",
            AnnotChild::PeriodName(_) => "periodName",
            AnnotChild::Symbol(_) => "symbol",
            AnnotChild::Table(_) => "table",
            AnnotChild::Corr(_) => "corr",
            AnnotChild::PersName(_) => "persName",
            AnnotChild::Dim(_) => "dim",
            AnnotChild::Sic(_) => "sic",
            AnnotChild::Ptr(_) => "ptr",
            AnnotChild::Lg(_) => "lg",
            AnnotChild::Supplied(_) => "supplied",
            AnnotChild::P(_) => "p",
            AnnotChild::Expan(_) => "expan",
            AnnotChild::Stamp(_) => "stamp",
            AnnotChild::Head(_) => "head",
            AnnotChild::Dimensions(_) => "dimensions",
            AnnotChild::Stack(_) => "stack",
            AnnotChild::Street(_) => "street",
            AnnotChild::Term(_) => "term",
            AnnotChild::Fig(_) => "fig",
            AnnotChild::StyleName(_) => "styleName",
            AnnotChild::List(_) => "list",
            AnnotChild::GeogFeat(_) => "geogFeat",
            AnnotChild::Title(_) => "title",
            AnnotChild::Orig(_) => "orig",
            AnnotChild::Annot(_) => "annot",
            AnnotChild::Choice(_) => "choice",
            AnnotChild::LocusGrp(_) => "locusGrp",
            AnnotChild::Damage(_) => "damage",
            AnnotChild::Bloc(_) => "bloc",
            AnnotChild::BiblStruct(_) => "biblStruct",
            AnnotChild::Identifier(_) => "identifier",
            AnnotChild::Reg(_) => "reg",
            AnnotChild::SecFolio(_) => "secFolio",
            AnnotChild::PostBox(_) => "postBox",
            AnnotChild::Q(_) => "q",
            AnnotChild::Address(_) => "address",
            AnnotChild::Country(_) => "country",
            AnnotChild::Gap(_) => "gap",
            AnnotChild::Seg(_) => "seg",
            AnnotChild::GeogName(_) => "geogName",
            AnnotChild::Pb(_) => "pb",
            AnnotChild::Width(_) => "width",
            AnnotChild::HandShift(_) => "handShift",
            AnnotChild::Relation(_) => "relation",
            AnnotChild::Del(_) => "del",
    ...
    fn serialize_mei<W: Write>(&self, writer: &mut MeiWriter<W>) -> SerializeResult<()> {
        match self {
            ...
            AnnotChild::District(elem) => elem.serialize_mei(writer),
            AnnotChild::Depth(elem) => elem.serialize_mei(writer),
            AnnotChild::CastList(elem) => elem.serialize_mei(writer),
            AnnotChild::Rend(elem) => elem.serialize_mei(writer),
            AnnotChild::Repository(elem) => elem.serialize_mei(writer),
            AnnotChild::Lb(elem) => elem.serialize_mei(writer),
            AnnotChild::Abbr(elem) => elem.serialize_mei(writer),
            AnnotChild::Restore(elem) => elem.serialize_mei(writer),
            AnnotChild::Catchwords(elem) => elem.serialize_mei(writer),
            AnnotChild::Heraldry(elem) => elem.serialize_mei(writer),
            AnnotChild::Add(elem) => elem.serialize_mei(writer),
            AnnotChild::PostCode(elem) => elem.serialize_mei(writer),
            AnnotChild::Unclear(elem) => elem.serialize_mei(writer),
            AnnotChild::Subst(elem) => elem.serialize_mei(writer),
            AnnotChild::Region(elem) => elem.serialize_mei(writer),
            AnnotChild::Ref(elem) => elem.serialize_mei(writer),
            AnnotChild::BiblList(elem) => elem.serialize_mei(writer),
            AnnotChild::RelationList(elem) => elem.serialize_mei(writer),
            AnnotChild::Quote(elem) => elem.serialize_mei(writer),
            AnnotChild::CorpName(elem) => elem.serialize_mei(writer),
            AnnotChild::Signatures(elem) => elem.serialize_mei(writer),
            AnnotChild::Num(elem) => elem.serialize_mei(writer),
            AnnotChild::EventList(elem) => elem.serialize_mei(writer),
            AnnotChild::Bibl(elem) => elem.serialize_mei(writer),
            AnnotChild::Extent(elem) => elem.serialize_mei(writer),
            AnnotChild::Locus(elem) => elem.serialize_mei(writer),
            AnnotChild::Settlement(elem) => elem.serialize_mei(writer),
            AnnotChild::Height(elem) => elem.serialize_mei(writer),
            AnnotChild::Name(elem) => elem.serialize_mei(writer),
            AnnotChild::PeriodName(elem) => elem.serialize_mei(writer),
            AnnotChild::Symbol(elem) => elem.serialize_mei(writer),
            AnnotChild::Table(elem) => elem.serialize_mei(writer),
            AnnotChild::Corr(elem) => elem.serialize_mei(writer),
            AnnotChild::PersName(elem) => elem.serialize_mei(writer),
            AnnotChild::Dim(elem) => elem.serialize_mei(writer),
            AnnotChild::Sic(elem) => elem.serialize_mei(writer),
            AnnotChild::Ptr(elem) => elem.serialize_mei(writer),
            AnnotChild::Lg(elem) => elem.serialize_mei(writer),
            AnnotChild::Supplied(elem) => elem.serialize_mei(writer),
            AnnotChild::P(elem) => elem.serialize_mei(writer),
            AnnotChild::Expan(elem) => elem.serialize_mei(writer),
            AnnotChild::Stamp(elem) => elem.serialize_mei(writer),
            AnnotChild::Head(elem) => elem.serialize_mei(writer),
            AnnotChild::Dimensions(elem) => elem.serialize_mei(writer),
            AnnotChild::Stack(elem) => elem.serialize_mei(writer),
            AnnotChild::Street(elem) => elem.serialize_mei(writer),
            AnnotChild::Term(elem) => elem.serialize_mei(writer),
            AnnotChild::Fig(elem) => elem.serialize_mei(writer),
            AnnotChild::StyleName(elem) => elem.serialize_mei(writer),
            AnnotChild::List(elem) => elem.serialize_mei(writer),
            AnnotChild::GeogFeat(elem) => elem.serialize_mei(writer),
            AnnotChild::Title(elem) => elem.serialize_mei(writer),
            AnnotChild::Orig(elem) => elem.serialize_mei(writer),
            AnnotChild::Annot(elem) => elem.serialize_mei(writer),
            AnnotChild::Choice(elem) => elem.serialize_mei(writer),
            AnnotChild::LocusGrp(elem) => elem.serialize_mei(writer),
            AnnotChild::Damage(elem) => elem.serialize_mei(writer),
            AnnotChild::Bloc(elem) => elem.serialize_mei(writer),
            AnnotChild::BiblStruct(elem) => elem.serialize_mei(writer),
            AnnotChild::Identifier(elem) => elem.serialize_mei(writer),
            AnnotChild::Reg(elem) => elem.serialize_mei(writer),
            AnnotChild::SecFolio(elem) => elem.serialize_mei(writer),
            AnnotChild::PostBox(elem) => elem.serialize_mei(writer),
            AnnotChild::Q(elem) => elem.serialize_mei(writer),
            AnnotChild::Address(elem) => elem.serialize_mei(writer),
            AnnotChild::Country(elem) => elem.serialize_mei(writer),
            AnnotChild::Gap(elem) => elem.serialize_mei(writer),
            AnnotChild::Seg(elem) => elem.serialize_mei(writer),
            AnnotChild::GeogName(elem) => elem.serialize_mei(writer),
            AnnotChild::Pb(elem) => elem.serialize_mei(writer),
            AnnotChild::Width(elem) => elem.serialize_mei(writer),
            AnnotChild::HandShift(elem) => elem.serialize_mei(writer),
            AnnotChild::Relation(elem) => elem.serialize_mei(writer),
            AnnotChild::Del(elem) => elem.serialize_mei(writer),
