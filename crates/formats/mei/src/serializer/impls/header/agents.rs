...
impl MeiSerialize for FunderChild {
    fn element_name(&self) -> &'static str {
        match self {
            ...
            FunderChild::Bibl(_) => "bibl",
            FunderChild::PostCode(_) => "postCode",
            FunderChild::Extent(_) => "extent",
            FunderChild::Identifier(_) => "identifier",
            FunderChild::PersName(_) => "persName",
            FunderChild::Ptr(_) => "ptr",
            FunderChild::Catchwords(_) => "catchwords",
            FunderChild::Term(_) => "term",
            FunderChild::Seg(_) => "seg",
            FunderChild::GeogName(_) => "geogName",
            FunderChild::Country(_) => "country",
            FunderChild::CorpName(_) => "corpName",
            FunderChild::Heraldry(_) => "heraldry",
            FunderChild::Q(_) => "q",
            FunderChild::Abbr(_) => "abbr",
            FunderChild::Ref(_) => "ref",
            FunderChild::Num(_) => "num",
            FunderChild::Annot(_) => "annot",
            FunderChild::Relation(_) => "relation",
            FunderChild::RelationList(_) => "relationList",
            FunderChild::Date(_) => "date",
            FunderChild::Repository(_) => "repository",
            FunderChild::Dim(_) => "dim",
            FunderChild::Expan(_) => "expan",
            FunderChild::Dimensions(_) => "dimensions",
            FunderChild::District(_) => "district",
            FunderChild::SecFolio(_) => "secFolio",
            FunderChild::Settlement(_) => "settlement",
            FunderChild::Symbol(_) => "symbol",
            FunderChild::Width(_) => "width",
            FunderChild::Rend(_) => "rend",
            FunderChild::Title(_) => "title",
            FunderChild::Lb(_) => "lb",
            FunderChild::GeogFeat(_) => "geogFeat",
            FunderChild::LocusGrp(_) => "locusGrp",
            FunderChild::Signatures(_) => "signatures",
            FunderChild::StyleName(_) => "styleName",
            FunderChild::Depth(_) => "depth",
            FunderChild::BiblStruct(_) => "biblStruct",
            FunderChild::Height(_) => "height",
            FunderChild::Street(_) => "street",
            FunderChild::Fig(_) => "fig",
            FunderChild::PeriodName(_) => "periodName",
            FunderChild::Name(_) => "name",
            FunderChild::Stack(_) => "stack",
            FunderChild::Stamp(_) => "stamp",
            FunderChild::Region(_) => "region",
            FunderChild::Bloc(_) => "bloc",
            FunderChild::PostBox(_) => "postBox",
            FunderChild::Locus(_) => "locus",
            FunderChild::Address(_) => "address",
        }
    }
    ...
    fn serialize_mei<W: Write>(&self, writer: &mut MeiWriter<W>) -> SerializeResult<()> {
        match self {
            ...
            FunderChild::Bibl(elem) => elem.serialize_mei(writer),
            FunderChild::PostCode(elem) => elem.serialize_mei(writer),
            FunderChild::Extent(elem) => elem.serialize_mei(writer),
            FunderChild::Identifier(elem) => elem.serialize_mei(writer),
            FunderChild::PersName(elem) => elem.serialize_mei(writer),
            FunderChild::Ptr(elem) => elem.serialize_mei(writer),
            FunderChild::Catchwords(elem) => elem.serialize_mei(writer),
            FunderChild::Term(elem) => elem.serialize_mei(writer),
            FunderChild::Seg(elem) => elem.serialize_mei(writer),
            FunderChild::GeogName(elem) => elem.serialize_mei(writer),
            FunderChild::Country(elem) => elem.serialize_mei(writer),
            FunderChild::CorpName(elem) => elem.serialize_mei(writer),
            FunderChild::Heraldry(elem) => elem.serialize_mei(writer),
            FunderChild::Q(elem) => elem.serialize_mei(writer),
            FunderChild::Abbr(elem) => elem.serialize_mei(writer),
            FunderChild::Ref(elem) => elem.serialize_mei(writer),
            FunderChild::Num(elem) => elem.serialize_mei(writer),
            FunderChild::Annot(elem) => elem.serialize_mei(writer),
            FunderChild::Relation(elem) => elem.serialize_mei(writer),
            FunderChild::RelationList(elem) => elem.serialize_mei(writer),
            FunderChild::Date(elem) => elem.serialize_mei(writer),
            FunderChild::Repository(elem) => elem.serialize_mei(writer),
            FunderChild::Dim(elem) => elem.serialize_mei(writer),
            FunderChild::Expan(elem) => elem.serialize_mei(writer),
            FunderChild::Dimensions(elem) => elem.serialize_mei(writer),
            FunderChild::District(elem) => elem.serialize_mei(writer),
            FunderChild::SecFolio(elem) => elem.serialize_mei(writer),
            FunderChild::Settlement(elem) => elem.serialize_mei(writer),
            FunderChild::Symbol(elem) => elem.serialize_mei(writer),
            FunderChild::Width(elem) => elem.serialize_mei(writer),
            FunderChild::Rend(elem) => elem.serialize_mei(writer),
            FunderChild::Title(elem) => elem.serialize_mei(writer),
            FunderChild::Lb(elem) => elem.serialize_mei(writer),
            FunderChild::GeogFeat(elem) => elem.serialize_mei(writer),
            FunderChild::LocusGrp(elem) => elem.serialize_mei(writer),
            FunderChild::Signatures(elem) => elem.serialize_mei(writer),
            FunderChild::StyleName(elem) => elem.serialize_mei(writer),
            FunderChild::Depth(elem) => elem.serialize_mei(writer),
            FunderChild::BiblStruct(elem) => elem.serialize_mei(writer),
            FunderChild::Height(elem) => elem.serialize_mei(writer),
            FunderChild::Street(elem) => elem.serialize_mei(writer),
            FunderChild::Fig(elem) => elem.serialize_mei(writer),
            FunderChild::PeriodName(elem) => elem.serialize_mei(writer),
            FunderChild::Name(elem) => elem.serialize_mei(writer),
            FunderChild::Stack(elem) => elem.serialize_mei(writer),
            FunderChild::Stamp(elem) => elem.serialize_mei(writer),
            FunderChild::Region(elem) => elem.serialize_mei(writer),
            FunderChild::Bloc(elem) => elem.serialize_mei(writer),
            FunderChild::PostBox(elem) => elem.serialize_mei(writer),
            FunderChild::Locus(elem) => elem.serialize_mei(writer),
            FunderChild::Address(elem) => elem.serialize_mei(writer),
        }
    }
}
