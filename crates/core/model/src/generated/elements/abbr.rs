...
/**abbreviation - A generic element for 1) a shortened form of a word, including an acronym
...
pub struct Abbr {
    ...
    #[serde(rename = "@expan", skip_serializing_if = "Option::is_none")]
    pub expan: Option<String>,
    /// Child elements.
