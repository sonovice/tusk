...
/**support description - Groups elements describing the physical support material of an
      item.*/
...
pub struct SupportDesc {
    ...
    /**Short, project-defined name for the material composing the majority of the
          support.*/
