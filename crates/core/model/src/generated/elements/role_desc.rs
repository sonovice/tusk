...
impl RoleDescChild {
    ...
    pub fn validate_with_context(&self, ctx: &mut ValidationContext, index: usize) {
        match self {
            ...
            RoleDescChild::Expan(elem) => {
                ctx.enter("expan", index);
                elem.validate_with_context(ctx);
                ctx.exit();
            }
            RoleDescChild::RelationList(elem) => {
            ...
            RoleDescChild::Seg(elem) => {
                ctx.enter("seg", index);
                elem.validate_with_context(ctx);
                ctx.exit();
            }
            RoleDescChild::PostBox(elem) => {
...
pub struct RoleDesc {
    ...
    pub children: Vec<RoleDescChild>,
}
impl Validate for RoleDesc {
