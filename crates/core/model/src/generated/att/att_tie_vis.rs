...
/**Visual domain attributes. The vo attribute is the vertical offset (from its normal
      ...
      lines. Startto and endto describe the start and end points in terms of time; that is,
      beats.*/
#[derive(Debug, Clone, Default, PartialEq, Serialize, Deserialize)]
pub struct AttTieVis {
    ...
    pub curvedir: Option<AttTieVisCurvedir>,
