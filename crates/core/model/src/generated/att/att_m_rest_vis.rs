...
pub enum AttMRestVisCutout {
    ///The staff lines should not be drawn.
    #[serde(rename = "cutout")]
    Cutout,
}
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, Serialize, Deserialize)]
pub enum AttMRestVisGlyphAuth {
...
pub struct AttMRestVis {
    ...
    pub cutout: Option<AttMRestVisCutout>,
    ...
    pub glyph_auth: Option<AttMRestVisGlyphAuth>,
