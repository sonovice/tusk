...
pub enum AttHairpinLogEvaluate {
...
pub struct AttHairpinLog {
    ...
    pub evaluate: Option<AttHairpinLogEvaluate>,
    ...
    pub form: Option<AttHairpinLogForm>,
    /**Indicates that the hairpin starts from or ends in silence. Often rendered as a small
          circle attached to the closed end of the hairpin. See Gould, p. 108.*/
    #[serde(rename = "@niente", skip_serializing_if = "Option::is_none")]
    pub niente: Option<crate::generated::data::DataBoolean>,
}
