...
pub enum AttHarpPedalLogEvaluate {
...
pub struct AttHarpPedalLog {
    ...
    pub evaluate: Option<AttHarpPedalLogEvaluate>,
    ...
    pub c: Option<crate::generated::data::DataHarppedalposition>,
    ///Indicates the pedal setting for the harp’s D strings.
    #[serde(rename = "@d", skip_serializing_if = "Option::is_none")]
    pub d: Option<crate::generated::data::DataHarppedalposition>,
    ///Indicates the pedal setting for the harp’s E strings.
    #[serde(rename = "@e", skip_serializing_if = "Option::is_none")]
    pub e: Option<crate::generated::data::DataHarppedalposition>,
    ///Indicates the pedal setting for the harp’s F strings.
    #[serde(rename = "@f", skip_serializing_if = "Option::is_none")]
    pub f: Option<crate::generated::data::DataHarppedalposition>,
    ///Indicates the pedal setting for the harp’s G strings.
    #[serde(rename = "@g", skip_serializing_if = "Option::is_none")]
    pub g: Option<crate::generated::data::DataHarppedalposition>,
    ///Indicates the pedal setting for the harp’s A strings.
    #[serde(rename = "@a", skip_serializing_if = "Option::is_none")]
    pub a: Option<crate::generated::data::DataHarppedalposition>,
    ///Indicates the pedal setting for the harp’s B strings.
    #[serde(rename = "@b", skip_serializing_if = "Option::is_none")]
    pub b: Option<crate::generated::data::DataHarppedalposition>,
}
