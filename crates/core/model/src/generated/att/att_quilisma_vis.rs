...
pub enum AttQuilismaVisGlyphAuth {
...
pub struct AttQuilismaVis {
    ...
    pub glyph_auth: Option<AttQuilismaVisGlyphAuth>,
    ...
    #[serde(rename = "@waves", skip_serializing_if = "Option::is_none")]
