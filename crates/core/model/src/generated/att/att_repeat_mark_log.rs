...
pub enum AttRepeatMarkLogEvaluate {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, Serialize, Deserialize)]
pub enum AttRepeatMarkLogFunc {
    ///Coda (SMuFL E048 or Unicode 1D10C).
    #[serde(rename = "coda")]
    Coda,
    ///Segno (SMuFL E047 or Unicode 1D10B).
    #[serde(rename = "segno")]
    Segno,
    ///Dal segno (SMuFL E045 or Unicode 1D109).
    #[serde(rename = "dalSegno")]
    DalSegno,
    ///Da capo (SMuFL E046 or Unicode 1D10A).
    #[serde(rename = "daCapo")]
    DaCapo,
    ///Fine. (text)
    #[serde(rename = "fine")]
    Fine,
    ///D.C. al Fine. (text)
    #[serde(rename = "daCapoAlFine")]
    DaCapoAlFine,
    ///D.S. al Fine. (text)
    #[serde(rename = "dalSegnoAlFine")]
    DalSegnoAlFine,
    ///D.C. al Coda. (text)
    #[serde(rename = "daCapoAlCoda")]
    DaCapoAlCoda,
    ///D.S. al Coda. (text)
    #[serde(rename = "dalSegnoAlCoda")]
    DalSegnoAlCoda,
    ///Left repeat barline as a separate symbol disconnected from staff lines (SMuFL E04C or Unicode 1D106)
    #[serde(rename = "repeatLeft")]
    RepeatLeft,
    ///Right repeat barline as a separate symbol disconnected from staff lines (SMuFL E04D or Unicode 1D107)
    #[serde(rename = "repeatRight")]
    RepeatRight,
    ///Right and left repeat barline as a separate symbol disconnected from staff lines (SMuFL E042)
    #[serde(rename = "repeatRightLeft")]
    RepeatRightLeft,
}
///Logical domain attributes.
#[derive(Debug, Clone, Default, PartialEq, Serialize, Deserialize)]
pub struct AttRepeatMarkLog {
    ...
    pub evaluate: Option<AttRepeatMarkLogEvaluate>,
    ...
    pub func: Option<AttRepeatMarkLogFunc>,
}
