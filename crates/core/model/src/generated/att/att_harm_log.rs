...
pub struct AttHarmLog {
    ...
    pub evaluate: Option<AttHarmLogEvaluate>,
    ...
    /**Contains a reference to achordDefelement elsewhere in the
    document.*/
    #[serde(rename = "@chordref", skip_serializing_if = "Option::is_none")]
    pub chordref: Option<crate::generated::data::DataUri>,
}
