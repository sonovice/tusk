...
pub enum AttFermataVisGlyphAuth {
    ///Standard Music Font Layout.
    #[serde(rename = "smufl")]
    Smufl,
}
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, Serialize, Deserialize)]
pub enum AttFermataVisForm {
...
pub struct AttFermataVis {
    ...
    pub glyph_auth: Option<AttFermataVisGlyphAuth>,
    ...
    pub y: Option<f64>,
    /**Describes the visual appearance of the fermata; that is, whether it occurs as upright
    or inverted.*/
    #[serde(rename = "@form", skip_serializing_if = "Option::is_none")]
    pub form: Option<AttFermataVisForm>,
    /**Describes the visual appearance of the fermata; that is, whether it has a curved,
    square, or angular shape.*/
    #[serde(rename = "@shape", skip_serializing_if = "Option::is_none")]
    pub shape: Option<AttFermataVisShape>,
}
