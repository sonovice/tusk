...
pub struct AttBeatRptLog {
    ...
    /**Indicates the performed duration represented by the beatRpt symbol; expressed in time
    signature denominator units.*/
    #[serde(rename = "@beatdef", skip_serializing_if = "Option::is_none")]
    pub beatdef: Option<f64>,
}
