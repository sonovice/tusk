...
pub enum AttMeterSigVisGlyphAuth {
...
pub struct AttMeterSigVis {
    ...
    pub glyph_auth: Option<AttMeterSigVisGlyphAuth>,
    ...
    pub form: Option<crate::generated::data::DataMeterform>,
}
