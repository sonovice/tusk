...
pub enum AttHispanTickVisGlyphAuth {
...
pub struct AttHispanTickVis {
    ...
    pub glyph_auth: Option<AttHispanTickVisGlyphAuth>,
    ...
    pub y: Option<f64>,
    /**Captures the placement of the tick mark with respect to the neume or neume component
