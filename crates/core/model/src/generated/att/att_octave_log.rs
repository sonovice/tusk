...
pub struct AttOctaveLog {
    ...
    pub evaluate: Option<AttOctaveLogEvaluate>,
    ...
    /**Indicates whether the octave displacement should be performed simultaneously with the
    ...
    pub coll: Option<AttOctaveLogColl>,
}
