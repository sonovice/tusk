...
pub enum AttFingGrpLogEvaluate {
...
pub struct AttFingGrpLog {
    ...
    pub evaluate: Option<AttFingGrpLogEvaluate>,
    ...
    pub form: Option<AttFingGrpLogForm>,
}
