...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, Serialize, Deserialize)]
pub enum AttLineLogFunc {
    /**Indicates coloration in material transcribed from a source originally in mensural
              notation.*/
    #[serde(rename = "coloration")]
    Coloration,
    /**Marks a ligature in material transcribed from a source originally in mensural
              notation.*/
...
pub struct AttLineLog {
    ...
    pub evaluate: Option<AttLineLogEvaluate>,
    ...
    pub func: Option<AttLineLogFunc>,
}
