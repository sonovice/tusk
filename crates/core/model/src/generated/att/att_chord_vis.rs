...
pub struct AttChordVis {
    ...
    pub glyph_auth: Option<AttChordVisGlyphAuth>,
    ...
    /**Indicates a single, alternative note head should be displayed instead of individual
    ...
    pub cluster: Option<crate::generated::data::DataCluster>,
}
