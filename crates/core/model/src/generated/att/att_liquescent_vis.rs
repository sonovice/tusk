...
pub enum AttLiquescentVisCurve {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, Serialize, Deserialize)]
pub enum AttLiquescentVisGlyphAuth {
...
pub struct AttLiquescentVis {
    ...
    pub curve: Option<AttLiquescentVisCurve>,
    ...
    pub glyph_auth: Option<AttLiquescentVisGlyphAuth>,
    ...
    pub looped: Option<crate::generated::data::DataBoolean>,
}
