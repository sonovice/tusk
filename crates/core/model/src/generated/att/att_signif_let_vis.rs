...
pub enum AttSignifLetVisGlyphAuth {
...
pub struct AttSignifLetVis {
    ...
    pub glyph_auth: Option<AttSignifLetVisGlyphAuth>,
    ...
    pub y: Option<f64>,
    /**Captures the placement of the sequence of characters with respect to the neume or
          neume component with which it is associated.*/
