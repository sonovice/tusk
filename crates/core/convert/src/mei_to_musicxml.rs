...
// ============================================================================
// MEI scoreDef/staffDef → MusicXML Attributes Conversion
// ============================================================================
...
// ============================================================================
// MEI Control Events → MusicXML Directions
// ============================================================================
...
fn convert_mei_duration_to_beat_unit(dur: &tusk_model::data::DataDuration) -> String {
    use tusk_model::data::{DataDuration, DataDurationCmn};
...
mod tests {
    ...
    // ========================================================================
    // MEI scoreDef/staffDef → MusicXML Attributes Tests
    // ========================================================================

    #[test]
    fn test_convert_mei_keysig_to_mxml_fifths() {
        use crate::mei_to_musicxml::convert_mei_keysig_to_fifths;
    ...
    fn test_convert_mei_meter_sym_to_mxml_time() {
        use crate::mei_to_musicxml::convert_mei_meter_sym_to_mxml;
        use tusk_model::data::DataMetersign;
        use tusk_musicxml::model::attributes::TimeSymbol;
    ...
    fn test_convert_mei_clef_shape_to_mxml() {
        use crate::mei_to_musicxml::convert_mei_clef_shape_to_mxml;
        use tusk_model::data::DataClefshape;
        use tusk_musicxml::model::attributes::ClefSign;
    ...
    fn test_convert_mei_score_def_to_mxml_attributes() {
        use crate::mei_to_musicxml::convert_score_def_to_attributes;
    ...
    fn test_convert_mei_staff_def_to_mxml_attributes() {
        use crate::mei_to_musicxml::convert_staff_def_to_attributes;
    ...
    // ========================================================================
    // MEI Control Events → MusicXML Direction Tests
    // ========================================================================

    #[test]
    fn test_convert_mei_dynam_basic() {
        use crate::mei_to_musicxml::convert_mei_dynam;
    ...
    fn test_convert_mei_hairpin_crescendo() {
        use crate::mei_to_musicxml::convert_mei_hairpin;
        use tusk_model::att::AttHairpinLogForm;
    ...
    fn test_convert_mei_dir_basic() {
        use crate::mei_to_musicxml::convert_mei_dir;
    ...
    fn test_convert_mei_tempo_basic() {
        use crate::mei_to_musicxml::convert_mei_tempo;
