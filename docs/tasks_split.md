...
- [ ] Extract measure/staff/layer/section/mdiv deserializers → `impls/structure.rs`
...
- [ ] Extract note/rest/chord/space serializers → `impls/note.rs`
...
- [ ] Extract note/rest/chord roundtrip tests → `roundtrip_tests/note.rs`
