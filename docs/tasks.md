...
- [ ] Implement custom serde serializer for MEI XML format
- [ ] Implement custom serde deserializer for MEI XML format
- [ ] Handle `xml:id` attribute serialization correctly
- [ ] Handle namespace declarations and prefixes
...
- [ ] Implement MEI parsing for `<note>` element
- [ ] Implement MEI parsing for `<rest>` element
- [ ] Implement MEI parsing for `<chord>` element
...
- [ ] Implement MEI parsing for `<scoreDef>` element
- [ ] Implement MEI parsing for `<staffDef>` element
- [ ] Implement MEI parsing for `<layerDef>` element
- [ ] Implement MEI parsing for `<staffGrp>` element
- [ ] Add score definition tests

### 2.4 Control Events
- [ ] Implement MEI parsing for `<slur>` element
- [ ] Implement MEI parsing for `<tie>` element
...
- [ ] Implement MEI parsing for `<meiHead>` element
- [ ] Implement MEI parsing for `<fileDesc>` element
- [ ] Implement MEI parsing for `<titleStmt>` element
- [ ] Implement MEI parsing for `<pubStmt>` element
- [ ] Implement MEI parsing for `<sourceDesc>` element

### 3.2 Encoding Description
- [ ] Implement MEI parsing for `<encodingDesc>` element
- [ ] Implement MEI parsing for `<appInfo>` element
- [ ] Implement MEI parsing for `<editorialDecl>` element
- [ ] Implement MEI parsing for `<projectDesc>` element

### 3.3 Work Description
- [ ] Implement MEI parsing for `<workList>` element
...
- [ ] Parse MusicXML rest elements
- [ ] Parse MusicXML chord notation (backup/forward)
- [ ] Parse MusicXML attributes (key, time, clef, divisions)
- [ ] Parse MusicXML direction elements
- [ ] Add MusicXML parser tests

### 4.3 MusicXML → MEI Conversion
- [ ] Create conversion context (state tracking, ID mapping)
- [ ] Convert MusicXML score-partwise to MEI structure
- [ ] Convert MusicXML part-list to MEI staffGrp/staffDef
...
- [ ] Convert MusicXML attributes to MEI scoreDef/staffDef
- [ ] Convert MusicXML directions to MEI control events
- [ ] Handle MusicXML divisions → MEI duration conversion
- [ ] Add MusicXML → MEI conversion tests

### 4.4 MEI → MusicXML Conversion
- [ ] Document MEI-only features that will be lost
- [ ] Convert MEI structure to MusicXML score-partwise
