...
- [ ] [VERSION_COMPAT] MEI 5.1 deprecated elements need migration: composer→Creator, lyricist→Creator, arranger→Creator, author→Creator; deserializer must map these on import (source: Aguado_Walzer_G-major.mei)
